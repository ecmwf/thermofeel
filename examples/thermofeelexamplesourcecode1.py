...
cosszaintegrated = calculate_cos_solar_zenith_angle_integrated(lat=lat_mg,lon=lon_mg,y=2020,m=6,d=8,h=6,tbegin=0,tend=6)
mrtinstant = calculate_mean_radiant_temperature(ssrd=ssrd, ssr=ssr, fdir=fdir, strd=strd,strr=strr,cossza=cosszainstant)
mrtintegrate = calculate_mean_radiant_temperature(ssrd=ssrd, ssr=ssr, fdir=fdir, strd=strd,strr=strr, cossza= cosszaintegrated)
...
ax.coastlines()
filled_c=plt.pcolormesh(lon_mg,lat_mg,(humidex) ,transform=ccrs.PlateCarree(),cmap="RdBu_r")
