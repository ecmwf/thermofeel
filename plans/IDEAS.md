...
- [ ] **More thermal indices.** Candidates frequently requested in
  ...
  Temperature (SET), Discomfort Index (Thom), WBGT via the full Liljegren model
  (promote `experimental_wbgt.py` once correct and tested). Each needs a citation
  and reference values before it can leave IDEAS.
