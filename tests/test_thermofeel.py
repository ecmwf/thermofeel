...
class TestThermalCalculator(unittest.TestCase):
    ...
    def test_heat_index(self):
        self.assert_equal_less_precise(self.heatindex, tfc.calculate_heat_index_simplified(self.t2m))
    ...
    def test_utci(self):
        ...
        self.assert_equal_less_precise(self.utci, tfc.calculate_utci(t2_k=self.t2m,va_ms=self.va,mrt_k=self.mrt,e_hPa=ehPa))
