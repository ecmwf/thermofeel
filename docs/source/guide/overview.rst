...
*thermofeel* is a thermal indices library which allows these indices to be integrated in numerical weather prediction systems. 
It was developed and is maintained by ECMWF (European Centre for Medium-Range Weather Forecasts).
