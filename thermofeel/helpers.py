...
def __declination_angle(jd, h):
    ...
    d = 0.396372 - 22.91327 * cos(grad) + 4.02543 * sin(grad) - 0.387205 * cos(2 * grad) + 0.051967 * sin(
        2 * grad) - 0.154527 * cos(3 * grad) + 0.084798 * sin(3 * grad)
    # time correction in [ h.degrees ]
    tc = 0.004297 + 0.107029 * cos(grad) - 1.837877 * sin(grad) \
        - 0.837378 * cos(2 * grad) - 2.340475 * sin(2 * grad)
    return d, tc
